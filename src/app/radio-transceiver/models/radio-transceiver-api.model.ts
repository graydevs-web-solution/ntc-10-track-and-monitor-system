...
interface ReceiverAndOtherEquipmentItem {
  ['id']?: number;
  ['name']: string;
  ['serial_number']: string;
  ['freq_range']: string;
...
export interface RadioTransceiverAPI {
  ...
  ['radio_transceiver_receivers']: ReceiverAndOtherEquipmentItem[];
  ['radio_transceiver_others']: ReceiverAndOtherEquipmentItem[];
